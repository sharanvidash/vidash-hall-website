    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <AnimatedSection variants={fadeIn}>
          <h2 className="text-4xl font-bold text-center mb-12 text-primary-purple">
            Visit Us
          </h2>
        </AnimatedSection>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <AnimatedSection variants={slideIn('left')} className="space-y-6">
            <h3 className="text-2xl font-semibold text-primary-coral">Shri Venkatesa Vidash Hall</h3>
            <p className="text-gray-600">
              Located on State High Road, our venue is easily accessible and provides
              a perfect setting for your special events. Call us now to book your next event, attractive prices and discounts available!
            </p>
            <div className="space-y-4">
              ...
              <p className="flex items-center space-x-4">
                ...
                <span className="text-gray-600">+91 87788 51010</span>
              </p>
              <p className="flex items-center space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-coral" viewBox="0 0 20 20" fill="currentColor">
              ...
              <a 
                ...
                className="inline-flex items-center space-x-2 text-primary-coral hover:text-primary-purple transition-colors"
              >
